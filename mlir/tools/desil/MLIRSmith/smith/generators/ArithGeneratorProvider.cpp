...
OpGenerator addFGenerator() {
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    region.pool.addTypeValue(tVal, "arith.addF");
...
OpGenerator addIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    //    candidates.insert(candidates.end(), region.pool.tensorPool.begin(),
    //                      region.pool.tensorPool.end());
    auto operands =
        searchIntegerBinaryOperandsFrom(builder, loc, candidates, "arith.addI");
    auto value =
        arith::AddIOp::create(builder, loc, operands[0].val, operands[1].val);
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.addI");
    return value.getOperation();
  };
}
...
OpGenerator andIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.andI");
    return value.getOperation();
  };
}
...
OpGenerator ceilDivSIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto value = arith::CeilDivSIOp::create(builder, loc, operands[0].val,
                                                    operands[1].val);
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.ceilDivSI");
    return value.getOperation();
  };
}
...
OpGenerator ceilDivUIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto value = arith::CeilDivUIOp::create(builder, loc, operands[0].val,
                                                    operands[1].val);
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.ceilDivUI");
    return value.getOperation();
  };
}
...
OpGenerator cmpFGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    if (mlir::dyn_cast<FloatType>(operands[0].type)) {
      ...
      region.pool.addIntOrFloat(tVal, "arith.cmpF");
      ...
      auto tVal =
          TypeValue(RankedTensorType::get(
                        ...
                        builder.getI1Type()),
                    value);
      region.pool.addTypeValue(tVal, "arith.cmpF");
    }
    return value.getOperation();
  };
}
...
OpGenerator cmpIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    if (mlir::dyn_cast<IntegerType>(operands[0].type)) {
      auto tVal = TypeValue(builder.getI1Type(), value);
      region.pool.addIntOrFloat(tVal, "arith.cmpI");
    } else if (mlir::dyn_cast<RankedTensorType>(operands[0].type)) {
      auto tVal =
          TypeValue(RankedTensorType::get(
                        mlir::dyn_cast<ShapedType>(operands[0].type).getShape(),
                        builder.getI1Type()),
                    value);
      region.pool.addTypeValue(tVal, "arith.cmpI");
    }
    return value.getOperation();
  };
}
...
OpGenerator constantGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    if (iType) {
      ...
      //
      // llvm::outs()<<"sdfsdfdsfs\n";

      //
      auto tVal = TypeValue(iType, cons);
      region.pool.addIntOrFloat(tVal, "arith.constant");
...
OpGenerator divFGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.divF");
    return value.getOperation();
  };
}
...
OpGenerator divSIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.divSI");
    return value.getOperation();
  };
}
...
OpGenerator divUIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.divUI");
    return value.getOperation();
  };
}
...
OpGenerator floorDivSIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto value = arith::FloorDivSIOp::create(builder, loc, operands[0].val,
                                                     operands[1].val);
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.floorDivSI");
    return value.getOperation();
  };
}
...
OpGenerator maxFGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto value =
        arith::MaxNumFOp::create(builder, loc, operands[0].val, operands[1].val);
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.maxF");
    return value.getOperation();
  };
}
...
OpGenerator maxSIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto operands = searchIntegerBinaryOperandsFrom(builder, loc, candidates,
                                                    "arith.maxSI");
    auto value =
        arith::MaxSIOp::create(builder, loc, operands[0].val, operands[1].val);
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.maxSI");
    return value.getOperation();
  };
}
...
OpGenerator maxUIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto operands = searchIntegerBinaryOperandsFrom(builder, loc, candidates,
                                                    "arith.maxUI");
    auto value =
        arith::MaxUIOp::create(builder, loc, operands[0].val, operands[1].val);
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.maxUI");
    return value.getOperation();
  };
}
...
OpGenerator minFGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto value =
        arith::MinimumFOp::create(builder, loc, operands[0].val, operands[1].val);
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.minF");
    return value.getOperation();
  };
}
...
OpGenerator minSIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.minSI");
    return value.getOperation();
  };
}
...
OpGenerator minUIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.minUI");
    return value.getOperation();
  };
}
...
OpGenerator mulFGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.mulF");
    return value.getOperation();
  };
}
...
OpGenerator mulIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.mulI");
    return value.getOperation();
  };
}
...
OpGenerator negFGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    region.pool.addTypeValue(tVal, "arith.negF");
    return value.getOperation();
  };
}
...
OpGenerator orIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.orI");
    return value.getOperation();
  };
}
...
OpGenerator remFGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.remF");
    return value.getOperation();
  };
}
...
OpGenerator remSIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.remSI");
    return value.getOperation();
  };
}
...
OpGenerator remUIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.remUI");
    return value.getOperation();
  };
}
...
OpGenerator shlIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.shlI");
    return value.getOperation();
  };
}
...
OpGenerator shrSIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.shrSI");
    return value.getOperation();
  };
}
...
OpGenerator shrUIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.shrUI");
    return value.getOperation();
  };
}
...
OpGenerator subFGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto value =
        arith::RemFOp::create(builder, loc, operands[0].val, operands[1].val);
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.subF");
    return value.getOperation();
  };
}
...
OpGenerator subIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.subI");
    return value.getOperation();
  };
}
...
OpGenerator xorIGenerator() {
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto tVal = TypeValue(operands[0].type, value);
    region.pool.addTypeValue(tVal, "arith.xorI");
    return value.getOperation();
  };
}