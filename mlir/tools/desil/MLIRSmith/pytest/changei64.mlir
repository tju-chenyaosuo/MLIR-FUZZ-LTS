module {
  func.func private @func1(%arg0: f32, %arg1: index, %arg2: tensor<?x?xi64>) -> tensor<?x?x?xf16> {
    ...
    %16 = "tosa.reduce_min"(%11) {axis = 0 : i32} : (tensor<?xf16>) -> tensor<1xf16>
    %17 = math.atan2 %cst, %cst_4 : f16
    %18 = tensor.empty(%c9, %c8) : tensor<?x?x10xf16>
    %19 = "tosa.reduce_min"(%9) {axis = 0 : i32} : (tensor<?x?xi1>) -> tensor<1x?xi1>
    %20 = arith.mulf %cst, %cst : f16
    %21 = math.atan2 %cst_1, %cst_4 : f16
    %22 = "tosa.reduce_prod"(%10) {axis = 0 : i32} : (tensor<?xi16>) -> tensor<1xi16>
    ...
    %38 = "tosa.reduce_max"(%3) {axis = 0 : i32} : (tensor<?x?x1xi32>) -> tensor<1x?x1xi32>
    %39 = "tosa.reduce_min"(%16) {axis = 0 : i32} : (tensor<1xf16>) -> tensor<1xf16>
    ...
    %86 = "tosa.reduce_sum"(%67) {axis = 0 : i32} : (tensor<1xf16>) -> tensor<1xf16>
    ...
    %134 = "tosa.reduce_all"(%65) {axis = 0 : i32} : (tensor<?x?x1xi32>) -> tensor<1x?x1xi32>
