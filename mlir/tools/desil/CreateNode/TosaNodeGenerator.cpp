...
OpGenerator tosaApplyScaleGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res = mlir::tosa::ApplyScaleOp::create(builder, 
...
OpGenerator tosaArithmeticRightShiftGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res = mlir::tosa::ArithmeticRightShiftOp::create(builder, 
...
number values or 4D tensor of number values output  unranked tensor of number
values or 4D tensor of number values void AvgPool2dOp::build(::mlir::OpBuilder
&odsBuilder, ::mlir::OperationState &odsState, ::mlir::Type outputType,
::mlir::Value input, ::mlir::DenseI64ArrayAttr kernel, ::mlir::DenseI64ArrayAttr
s tride, ::mlir::DenseI64ArrayAttr pad)
*/
  ...
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mb->search(
        [&](std::string s, mlir::Value v) -> bool {
          if (!(ranked_tensor_filter(s, v)))
            return false;
          return mlir::dyn_cast<RankedTensorType>(v.getType()).getElementType() ==
                 builder.getI1Type();
        },
        &operandCandidates);
    if (operandCandidates.empty()) {
...
OpGenerator tosaLogicalLeftShiftOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res_tensor = mlir::tosa::LogicalLeftShiftOp::create(builder, 
...
OpGenerator tosaLogicalRightShiftOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res_tensor = mlir::tosa::LogicalRightShiftOp::create(builder, 
        loc, output, input1, input2);
    mb->add2Pool(res_tensor);
    return true;
  };
...
OpGenerator tosaMaxPool2dOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res = mlir::tosa::MaxPool2dOp::create(builder, 
  ...
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mb->search(
        [&](std::string s, mlir::Value v) -> bool {
          ...
          return mlir::dyn_cast<RankedTensorType>(v.getType()).getElementType() ==
                     builder.getI64Type() ||
                 mlir::dyn_cast<RankedTensorType>(v.getType()).getElementType() ==
                     builder.getI32Type();
        },
        &paddingsCandidates);
...
OpGenerator tosaReduceAllOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    uint64_t axis = rollIdx(mlir::dyn_cast<RankedTensorType>(src1.getType()).getRank());
    mlir::Value res =
...
OpGenerator tosaRescaleOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res = mlir::tosa::RescaleOp::create(builder, 
...
OpGenerator tosaResizeOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res = mlir::tosa::ResizeOp::create(builder, 
...
OpGenerator tosaScatterOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res = mlir::tosa::ScatterOp::create(builder, 
...
OpGenerator tosaSelectOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res_tensor = mlir::tosa::SelectOp::create(builder, 
...
OpGenerator tosaSigmoidOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res = mlir::tosa::SigmoidOp::create(builder, loc, output, input);
    mb->add2Pool(res);
    return true;
  };
}
...
OpGenerator tosaSliceOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    for (int i = 0; i < mlir::dyn_cast<RankedTensorType>(input.getType()).getRank();
         i++) {
