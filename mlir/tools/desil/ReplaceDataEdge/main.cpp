...
static cl::opt<double> operandProb("operand-prob",
                        cl::desc("Operand mutation probability"),
                        cl::init(0.5),
                        cl::value_desc("floating point(double in the program) value."));
...
int main(int argc, char **argv) {
  ...
  MutationParser mp = MutationParser(operandProb, mutPos);
